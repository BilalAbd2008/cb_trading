...
function BenefitCard({
  ...
  return (
    <div
      ref={ref}
      className={`bg-gradient-to-br from-primary-800/50 to-primary-900/50 backdrop-blur-sm border border-purple-500/20 rounded-xl p-6 text-center hover:border-purple-500/50 transition-all duration-700 ease-out ${
